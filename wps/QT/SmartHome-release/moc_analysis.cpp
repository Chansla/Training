...
QT_MOC_LITERAL(1, 9, 15), // "sendQJsonObject"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12), // "jsonAnalysis"
QT_MOC_LITERAL(4, 39, 3) // "msg"

    },
    "Analysis\0sendQJsonObject\0\0jsonAnalysis\0"
    "msg"
};
...
void Analysis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendQJsonObject((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 1: _t->jsonAnalysis((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Analysis::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Analysis::sendQJsonObject)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Analysis::sendQJsonObject(QJsonObject _t1)
{
