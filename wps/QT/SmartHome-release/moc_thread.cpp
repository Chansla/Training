...
QT_MOC_LITERAL(1, 7, 14), // "sendQByteArray"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Thread\0sendQByteArray\0"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Thread::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::sendQByteArray)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::sendQByteArray(QByteArray _t1)
{
