...
QT_MOC_LITERAL(1, 5, 14), // "sendQByteArray"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4), // "data"
QT_MOC_LITERAL(4, 26, 16), // "data_utf8_encode"
QT_MOC_LITERAL(5, 43, 8), // "QString&"
QT_MOC_LITERAL(6, 52, 14) // "send_reply_msg"

    },
    "Http\0sendQByteArray\0\0data\0data_utf8_encode\0"
    "QString&\0send_reply_msg"
};
...
void Http::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendQByteArray((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->data_utf8_encode((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->send_reply_msg(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Http::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Http::sendQByteArray)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Http::sendQByteArray(QByteArray _t1)
{
